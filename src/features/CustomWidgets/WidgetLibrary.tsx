...
export const WIDGET_LIBRARY = [
  ...
  { id: 'markdown', name: 'Markdown', icon: FileText, description: 'Text preview' },
  { id: 'worldclock', name: 'World Clock', icon: Globe, description: 'Local offsets' },
  { id: 'system', name: 'Stats', icon: Cpu, description: 'System monitor' },
  { id: 'quotes', name: 'Inspiration', icon: Quote, description: 'Daily wisdom' },
  { id: 'habit', name: 'Habits', icon: CheckSquare, description: 'Daily tracker' },
  { id: 'hydration', name: 'Water', icon: Droplets, description: 'Drink tracker' },
  { id: 'fortune', name: 'Fortune', icon: Cookie, description: 'Wisdom cookie' },
  { id: 'dice', name: 'Dice', icon: Dices, description: 'Random roller' },
  { id: 'converter', name: 'Units', icon: ArrowRightLeft, description: 'Converter' },
  { id: 'breathing', name: 'Breathe', icon: Wind, description: 'Directed air' },
  ...
  { id: 'flashcards', name: 'Learn', icon: Layers, description: 'Study flips' },
